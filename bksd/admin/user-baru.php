...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12">
  	...
  	<p style="margin-bottom:10px;">
  		<strong style="font-size:18pt;"><span class="fa fa-clone"></span> Tambah Admin</strong>
  	</p>
      ...
      <div class="panel-body">
        <form method="post" id="form">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" minlength="5" required="on">
          </div>
          <!--<div class="form-group">
