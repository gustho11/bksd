...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12">
    <ol class="breadcrumb">
      ...
      <li><a href="user.php">Data Admin</a></li>
      <li class="active">Ubah Data</li>
    </ol>
    <p style="margin-bottom:10px;">
      <strong style="font-size:18pt;"><span class="fa fa-pencil"></span> Ubah Admin</strong>
    </p>
      ...
      <div class="panel-body">
        <form method="post" id="form">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="<?php echo $eks->nama_lengkap; ?>" minlength="5" required="on">
          </div>
          <!--<div class="form-group">
