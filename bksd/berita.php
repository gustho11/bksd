<?php
    ...
    $query = "SELECT * FROM berita ORDER BY id_berita DESC LIMIT $halaman_awal, $batas";
                                ...
                                <div class="row">
                                    <div class="col col-md-3">
                                        <center>
                                            <div class="media-left">
                                                <div>
                                                    <img src="admin/file/berita/tampilan/<?=$row['tampilan'] ?>" height="150" width="150">
                                                </div>
                                            </div>
                                        </center>
                                    </div>
                                    <div class="col col-md-9">
                                        <div class="media-body">
                                            <h4><a href="#" style="color: #0088cc;"><?=$row['judul_berita'] ?></a></h4>
                                                <div class="meta">
